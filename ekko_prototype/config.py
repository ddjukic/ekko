...
class Config:
    ...
    NGROK_URL: str = os.getenv("NGROK_URL", "https://2f21-134-195-195-182.ngrok-free.app")
    TRANSCRIPTION_SERVER_TOKEN: str = os.getenv("TRANSCRIPTION_SERVER_TOKEN", "chamberOfSecrets")
    ...
    USE_REMOTE_WHISPER: bool = os.getenv("USE_REMOTE_WHISPER", "false").lower() == "true"
    PREFER_YOUTUBE_TRANSCRIPTS: bool = os.getenv("PREFER_YOUTUBE_TRANSCRIPTS", "true").lower() == "true"
