...
class TestYouTubeDetector(unittest.TestCase):
    ...
    def test_fetch_youtube_transcript_not_available(self, mock_api):
        ...
        mock_transcript_list = Mock()
        mock_transcript_list.find_manually_created_transcript.side_effect = Exception("No manual transcript")
        mock_transcript_list.find_generated_transcript.side_effect = Exception("No auto transcript")
        mock_api.list_transcripts.return_value = mock_transcript_list
    ...
    def test_calculate_quality_score(self):
        ...
        good_transcript = "This is a high quality transcript with proper sentences. " * 100
